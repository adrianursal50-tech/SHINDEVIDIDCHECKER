...
Env:
  ...
  MLBB_MAX_INFLIGHT  default 4   (concurrent logins — the real throttle)
  MLBB_MIN_GAP       default 0.4 (seconds between login starts)
  MLBB_FREE          "1" → no key required

Proxy file (optional): proxies.txt, one per line:
